...
@protocol OAIPhoneNumberProjection;
@class OAIPhoneNumberProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPagePhoneNumberProjection
@end

@interface OAIPagePhoneNumberProjection : OAIObject


@property(nonatomic) NSArray<OAIPhoneNumberProjection>* content;
