...
#import "OAISort.h"
@protocol OAIDeliveryStatus;
@class OAIDeliveryStatus;
...
@protocol OAIPageDeliveryStatus
@end

@interface OAIPageDeliveryStatus : OAIObject


@property(nonatomic) NSArray<OAIDeliveryStatus>* content;
