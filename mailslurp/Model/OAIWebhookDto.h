...
/* ID of AI transformer for payload [optional]
 */
@property(nonatomic) NSString* aiTransformId;
/* Should notifier ignore insecure SSL certificates [optional]
 */
@property(nonatomic) NSNumber* ignoreInsecureSslCertificates;
/* Should notifier use static IP range when sending webhook payload [optional]
 */
@property(nonatomic) NSNumber* useStaticIpRange;
/* Webhook health [optional]
 */
