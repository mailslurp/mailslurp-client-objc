...
@class OAIWebhookResultEntity;



@protocol OAIPageWebhookResult
@end

@interface OAIPageWebhookResult : OAIObject


@property(nonatomic) NSArray<OAIWebhookResultEntity>* content;
