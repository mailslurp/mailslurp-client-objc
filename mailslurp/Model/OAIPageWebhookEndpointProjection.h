...
@class OAISortObject;
@protocol OAIWebhookEndpointProjection;
@class OAIWebhookEndpointProjection;



@protocol OAIPageWebhookEndpointProjection
@end

@interface OAIPageWebhookEndpointProjection : OAIObject


@property(nonatomic) NSArray<OAIWebhookEndpointProjection>* content;
