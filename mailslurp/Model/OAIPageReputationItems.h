...
@protocol OAIReputationItemProjection;
@class OAIReputationItemProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPageReputationItems
@end

@interface OAIPageReputationItems : OAIObject


@property(nonatomic) NSArray<OAIReputationItemProjection>* content;
