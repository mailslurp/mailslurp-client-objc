...
@protocol OAIGuestPortalUserProjection;
@class OAIGuestPortalUserProjection;
...
@protocol OAIPageGuestPortalUsers
@end

@interface OAIPageGuestPortalUsers : OAIObject


@property(nonatomic) NSArray<OAIGuestPortalUserProjection>* content;
