...
@class OAIOrganizationInboxProjection;
...
@protocol OAIPageOrganizationInboxProjection
@end

@interface OAIPageOrganizationInboxProjection : OAIObject


@property(nonatomic) NSArray<OAIOrganizationInboxProjection>* content;
