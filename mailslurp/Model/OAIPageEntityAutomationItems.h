...
@protocol OAIEntityAutomationItemProjection;
@class OAIEntityAutomationItemProjection;
...
@protocol OAIPageEntityAutomationItems
@end

@interface OAIPageEntityAutomationItems : OAIObject


@property(nonatomic) NSArray<OAIEntityAutomationItemProjection>* content;
