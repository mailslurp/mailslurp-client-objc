...
/* ID of attachment. Use the `AttachmentController` to [optional]
 */
@property(nonatomic) NSString* attachmentId;
/* Filename of the attachment if present [optional]
 */
@property(nonatomic) NSString* name;
/* Content type of attachment such as 'image/png' or 'application/pdf [optional]
 */
