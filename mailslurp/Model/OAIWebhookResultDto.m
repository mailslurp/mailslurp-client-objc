...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"userId", @"inboxId", @"webhookId", @"webhookUrl", @"messageId", @"redriveId", @"httpMethod", @"webhookEvent", @"responseStatus", @"responseTimeMillis", @"responseBodyExtract", @"resultType", @"createdAt", @"updatedAt", @"seen"];
