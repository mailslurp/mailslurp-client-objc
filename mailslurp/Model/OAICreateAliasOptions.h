...
/* Custom domain ID to use when generating alias email addresses [optional]
 */
@property(nonatomic) NSString* domainId;
/* Whether to verify the masked email address exists before sending an email to it [optional]
 */
@property(nonatomic) NSNumber* verifyEmailAddress;
