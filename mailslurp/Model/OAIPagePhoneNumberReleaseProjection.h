...
@protocol OAIPhoneNumberReleaseProjection;
@class OAIPhoneNumberReleaseProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPagePhoneNumberReleaseProjection
@end

@interface OAIPagePhoneNumberReleaseProjection : OAIObject


@property(nonatomic) NSArray<OAIPhoneNumberReleaseProjection>* content;
