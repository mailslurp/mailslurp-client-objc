...
#import "OAISort.h"
@protocol OAIBounceRecipientProjection;
@class OAIBounceRecipientProjection;
...
@protocol OAIPageBouncedRecipients
@end

@interface OAIPageBouncedRecipients : OAIObject


@property(nonatomic) NSArray<OAIBounceRecipientProjection>* content;
