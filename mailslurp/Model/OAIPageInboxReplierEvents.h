...
@class OAIInboxReplierEventProjection;
...
@protocol OAIPageInboxReplierEvents
@end

@interface OAIPageInboxReplierEvents : OAIObject


@property(nonatomic) NSArray<OAIInboxReplierEventProjection>* content;
