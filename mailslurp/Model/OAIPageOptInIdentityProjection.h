...
@protocol OAIOptInIdentityProjection;
@class OAIOptInIdentityProjection;
...
@protocol OAIPageOptInIdentityProjection
@end

@interface OAIPageOptInIdentityProjection : OAIObject


@property(nonatomic) NSArray<OAIOptInIdentityProjection>* content;
