...
/* Optional HTML flag (Deprecated: use isHTML instead) [optional]
 */
...
/* Use name of inbox as sender email address name. Will construct RFC 5322 email address with `Inbox name <inbox@address.com>` [optional]
 */
