...
@protocol OAISendEmailBodyPart;
@class OAISendEmailBodyPart;
...
/* Optional from name if not passed with address. If you set `useInboxName` to `true` the from field will include the inbox name as a display name [optional]
 */
...
/* Optional custom headers [optional]
 */
...
/* Optional HTML flag to indicate that contents is HTML. Set's a `content-type: text/html` for email. (Deprecated: use `isHTML` instead.) [optional]
 */
...
/* Use name of inbox as sender email address name. Will construct RFC 5322 email address with `Inbox name <inbox@address.com>` if the inbox has a name. [optional]
 */
@property(nonatomic) NSNumber* useInboxName;
/* Add tracking pixel to email [optional]
 */
@property(nonatomic) NSNumber* addTrackingPixel;
/* Filter recipients to remove any bounced recipients from to, bcc, and cc before sending [optional]
 */
@property(nonatomic) NSNumber* filterBouncedRecipients;
/* Validate recipient email addresses before sending [optional]
 */
@property(nonatomic) NSString* validateEmailAddresses;
/* Ignore empty recipients after validation removes all recipients as invalid and fail silently [optional]
 */
@property(nonatomic) NSNumber* ignoreEmptyRecipients;
/* Is content AMP4EMAIL compatible. If set will send as x-amp-html part. [optional]
 */
@property(nonatomic) NSNumber* isXAmpHtml;
/* Email body content parts for multipart mime message. Will override body. [optional]
 */
@property(nonatomic) NSArray<OAISendEmailBodyPart>* bodyParts;
