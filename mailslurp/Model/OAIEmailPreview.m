...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"inboxId", @"domainId", @"subject", @"from", @"bcc", @"cc", @"attachments", @"threadId", @"messageId", @"inReplyTo", @"sender", @"recipients", @"favourite", @"bodyPartContentTypes", @"plusAddress"];
