...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"domainId", @"from", @"sender", @"recipients", @"replyTo", @"cc", @"bcc", @"headers", @"headersMap", @"attachments", @"subject", @"body", @"bodyExcerpt", @"textExcerpt", @"bodyMD5Hash", @"isHTML", @"charset", @"analysis", @"isXAmpHtml", @"bodyPartContentTypes", @"externalId", @"messageId", @"threadId", @"inReplyTo", @"favourite", @"sizeBytes", @"xampHtml", @"html"];
