...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"from", @"sender", @"recipients", @"replyTo", @"cc", @"bcc", @"headers", @"attachments", @"subject", @"body", @"bodyExcerpt", @"bodyMD5Hash", @"isHTML", @"charset", @"analysis", @"html"];
