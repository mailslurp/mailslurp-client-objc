...
#import "OAISort.h"
@protocol OAIConnectorSyncEventProjection;
@class OAIConnectorSyncEventProjection;
...
@protocol OAIPageConnectorSyncEvents
@end

@interface OAIPageConnectorSyncEvents : OAIObject


@property(nonatomic) NSArray<OAIConnectorSyncEventProjection>* content;
