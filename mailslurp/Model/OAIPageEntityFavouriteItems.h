...
@protocol OAIEntityFavouriteItemProjection;
@class OAIEntityFavouriteItemProjection;
...
@protocol OAIPageEntityFavouriteItems
@end

@interface OAIPageEntityFavouriteItems : OAIObject


@property(nonatomic) NSArray<OAIEntityFavouriteItemProjection>* content;
