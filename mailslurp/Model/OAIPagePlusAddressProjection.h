...
@protocol OAIPlusAddressProjection;
@class OAIPlusAddressProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPagePlusAddressProjection
@end

@interface OAIPagePlusAddressProjection : OAIObject


@property(nonatomic) NSArray<OAIPlusAddressProjection>* content;
