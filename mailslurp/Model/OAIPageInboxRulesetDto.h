...
#import "OAISort.h"
@protocol OAIInboxRulesetDto;
@class OAIInboxRulesetDto;
...
@protocol OAIPageInboxRulesetDto
@end

@interface OAIPageInboxRulesetDto : OAIObject


@property(nonatomic) NSArray<OAIInboxRulesetDto>* content;
