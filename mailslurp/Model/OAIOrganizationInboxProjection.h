...
/* Name of the inbox. Displayed in the dashboard for easier search [optional]
 */
@property(nonatomic) NSString* name;
/* Is the inbox readOnly for the caller. Read only means can not be deleted or modified. [optional]
 */
...
/* Does inbox permit team access for organization team members. If so team users can use inbox and emails associated with it. [optional]
 */
