...
#import "OAISort.h"
@protocol OAIInboxRulesetProjection;
@class OAIInboxRulesetProjection;
...
@protocol OAIPageInboxRulesetProjection
@end

@interface OAIPageInboxRulesetProjection : OAIObject


@property(nonatomic) NSArray<OAIInboxRulesetProjection>* content;
