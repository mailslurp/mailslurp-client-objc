...
@implementation OAIEmailAuditAnalysisResult
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"featureSupport", @"htmlValidation", @"errorMessage"];
