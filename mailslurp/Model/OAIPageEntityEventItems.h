...
@protocol OAIEntityEventItemProjection;
@class OAIEntityEventItemProjection;
...
@protocol OAIPageEntityEventItems
@end

@interface OAIPageEntityEventItems : OAIObject


@property(nonatomic) NSArray<OAIEntityEventItemProjection>* content;
