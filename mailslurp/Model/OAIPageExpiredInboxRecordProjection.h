...
#import "OAISort.h"
@protocol OAIExpiredInboxRecordProjection;
@class OAIExpiredInboxRecordProjection;
...
@protocol OAIPageExpiredInboxRecordProjection
@end

@interface OAIPageExpiredInboxRecordProjection : OAIObject


@property(nonatomic) NSArray<OAIExpiredInboxRecordProjection>* content;
