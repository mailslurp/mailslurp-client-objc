...
@protocol OAIMissedSmsProjection;
@class OAIMissedSmsProjection;
...
@protocol OAIPageMissedSmsProjection
@end

@interface OAIPageMissedSmsProjection : OAIObject


@property(nonatomic) NSArray<OAIMissedSmsProjection>* content;
