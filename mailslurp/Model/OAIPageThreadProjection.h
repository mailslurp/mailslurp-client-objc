...
@class OAIThreadProjection;



@protocol OAIPageThreadProjection
@end

@interface OAIPageThreadProjection : OAIObject


@property(nonatomic) NSArray<OAIThreadProjection>* content;
