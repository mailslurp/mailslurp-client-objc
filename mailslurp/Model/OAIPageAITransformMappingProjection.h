...
@protocol OAIAITransformMappingProjection;
@class OAIAITransformMappingProjection;
...
@protocol OAIPageAITransformMappingProjection
@end

@interface OAIPageAITransformMappingProjection : OAIObject


@property(nonatomic) NSArray<OAIAITransformMappingProjection>* content;
