...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"subject", @"sender", @"recipients", @"attachments", @"cc", @"bcc", @"messageId", @"domainId", @"favourite", @"plusAddress", @"sizeBytes", @"inReplyTo", @"bodyExcerpt", @"textExcerpt", @"bodyPartContentTypes", @"bodyMD5Hash", @"threadId", ];
