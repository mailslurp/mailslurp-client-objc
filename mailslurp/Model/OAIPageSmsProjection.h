...
@protocol OAISmsProjection;
@class OAISmsProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPageSmsProjection
@end

@interface OAIPageSmsProjection : OAIObject


@property(nonatomic) NSArray<OAISmsProjection>* content;
