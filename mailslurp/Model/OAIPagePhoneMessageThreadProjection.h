...
@class OAIPhoneMessageThreadProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPagePhoneMessageThreadProjection
@end

@interface OAIPagePhoneMessageThreadProjection : OAIObject


@property(nonatomic) NSArray<OAIPhoneMessageThreadProjection>* content;
