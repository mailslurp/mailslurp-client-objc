...
@protocol OAISort;
@class OAISort;
@protocol OAITrackingPixelProjection;
@class OAITrackingPixelProjection;



@protocol OAIPageTrackingPixelProjection
@end

@interface OAIPageTrackingPixelProjection : OAIObject


@property(nonatomic) NSArray<OAITrackingPixelProjection>* content;
