...
@protocol OAISentSmsProjection;
@class OAISentSmsProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPageSentSmsProjection
@end

@interface OAIPageSentSmsProjection : OAIObject


@property(nonatomic) NSArray<OAISentSmsProjection>* content;
