...
@protocol OAISort;
@class OAISort;
@protocol OAIUnknownMissedEmailProjection;
@class OAIUnknownMissedEmailProjection;



@protocol OAIPageUnknownMissedEmailProjection
@end

@interface OAIPageUnknownMissedEmailProjection : OAIObject


@property(nonatomic) NSArray<OAIUnknownMissedEmailProjection>* content;
