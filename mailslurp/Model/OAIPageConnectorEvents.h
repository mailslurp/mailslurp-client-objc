...
@class OAIConnectorEventProjection;
...
@protocol OAIPageConnectorEvents
@end

@interface OAIPageConnectorEvents : OAIObject


@property(nonatomic) NSArray<OAIConnectorEventProjection>* content;
