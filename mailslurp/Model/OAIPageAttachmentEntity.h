...
#import "OAISort.h"
@protocol OAIAttachmentEntity;
@class OAIAttachmentEntity;
...
@protocol OAIPageAttachmentEntity
@end

@interface OAIPageAttachmentEntity : OAIObject


@property(nonatomic) NSArray<OAIAttachmentEntity>* content;
