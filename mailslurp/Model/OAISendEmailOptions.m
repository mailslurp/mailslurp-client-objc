...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"attachments", @"bcc", @"body", @"cc", @"charset", @"from", @"html", @"isHTML", @"replyTo", @"sendStrategy", @"subject", @"template", @"templateVariables", @"to", @"toContacts", @"toGroup", @"useInboxName"];
