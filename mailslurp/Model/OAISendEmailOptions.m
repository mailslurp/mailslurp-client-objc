...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"toContacts", @"toGroup", @"to", @"from", @"cc", @"bcc", @"subject", @"replyTo", @"body", @"html", @"isHTML", @"charset", @"attachments", @"templateVariables", @"template", @"sendStrategy", @"useInboxName", @"addTrackingPixel"];
