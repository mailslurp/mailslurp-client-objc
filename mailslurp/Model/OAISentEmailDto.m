...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"domainId", @"to", @"from", @"replyTo", @"cc", @"bcc", @"attachments", @"subject", @"bodyMD5Hash", @"body", @"toContacts", @"toGroup", @"charset", @"isHTML", @"pixelIds", @"messageId", @"messageIds", @"virtualSend", @"templateId", @"templateVariables", @"html"];
