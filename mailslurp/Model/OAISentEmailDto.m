...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"domainId", @"to", @"from", @"sender", @"recipients", @"replyTo", @"cc", @"bcc", @"attachments", @"subject", @"bodyMD5Hash", @"body", @"toContacts", @"toGroup", @"charset", @"isHTML", @"pixelIds", @"messageId", @"messageIds", @"virtualSend", @"templateId", @"templateVariables", @"headers", @"threadId", @"bodyExcerpt", @"textExcerpt", @"inReplyTo", @"favourite", @"html"];
