...
#import "OAISort.h"
@protocol OAIListUnsubscribeRecipientProjection;
@class OAIListUnsubscribeRecipientProjection;
...
@protocol OAIPageListUnsubscribeRecipients
@end

@interface OAIPageListUnsubscribeRecipients : OAIObject


@property(nonatomic) NSArray<OAIListUnsubscribeRecipientProjection>* content;
