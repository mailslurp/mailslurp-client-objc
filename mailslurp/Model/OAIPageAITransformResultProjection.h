...
@protocol OAIAITransformResultProjectionDto;
@class OAIAITransformResultProjectionDto;
...
@protocol OAIPageAITransformResultProjection
@end

@interface OAIPageAITransformResultProjection : OAIObject


@property(nonatomic) NSArray<OAIAITransformResultProjectionDto>* content;
