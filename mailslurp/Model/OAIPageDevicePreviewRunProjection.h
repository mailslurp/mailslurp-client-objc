...
@protocol OAIPageDevicePreviewRunProjection
@end

@interface OAIPageDevicePreviewRunProjection : OAIObject


@property(nonatomic) NSArray<OAIDevicePreviewRunDto>* content;
