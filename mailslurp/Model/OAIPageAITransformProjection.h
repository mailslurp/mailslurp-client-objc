...
@class OAIAITransformProjection;
...
@protocol OAIPageAITransformProjection
@end

@interface OAIPageAITransformProjection : OAIObject


@property(nonatomic) NSArray<OAIAITransformProjection>* content;
