...
#import "OAISort.h"
@protocol OAIInboxForwarderDto;
@class OAIInboxForwarderDto;
...
@protocol OAIPageInboxForwarderDto
@end

@interface OAIPageInboxForwarderDto : OAIObject


@property(nonatomic) NSArray<OAIInboxForwarderDto>* content;
