...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"aiTransformId", @"aiTransformMappingId", @"rawInput", @"entityId", @"entityType", @"rawConditions", @"rawInstructions", @"rawOutputSchema", @"contentSelector", @"saveResults"];
