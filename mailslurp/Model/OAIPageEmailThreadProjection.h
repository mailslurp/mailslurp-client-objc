...
@class OAIEmailThreadProjection;
...
@protocol OAIPageEmailThreadProjection
@end

@interface OAIPageEmailThreadProjection : OAIObject


@property(nonatomic) NSArray<OAIEmailThreadProjection>* content;
