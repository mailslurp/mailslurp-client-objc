...
@class OAIAliasThreadProjection;
...
@protocol OAIPageAliasThreadProjection
@end

@interface OAIPageAliasThreadProjection : OAIObject


@property(nonatomic) NSArray<OAIAliasThreadProjection>* content;
