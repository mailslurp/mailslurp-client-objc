...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"name", @"phoneId", @"inboxId", @"requestBodyTemplate", @"eventName", @"requestHeaders", @"ignoreInsecureSslCertificates", @"useStaticIpRange", @"healthStatus"];
