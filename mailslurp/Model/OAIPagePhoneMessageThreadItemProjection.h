...
@protocol OAIPhoneMessageThreadItemProjection;
@class OAIPhoneMessageThreadItemProjection;
@protocol OAISortObject;
@class OAISortObject;



@protocol OAIPagePhoneMessageThreadItemProjection
@end

@interface OAIPagePhoneMessageThreadItemProjection : OAIObject


@property(nonatomic) NSArray<OAIPhoneMessageThreadItemProjection>* content;
