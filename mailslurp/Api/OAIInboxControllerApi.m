...
-(NSURLSessionTask*) createInboxRulesetWithInboxId: (NSString*) inboxId
    createRulesetOptions: (OAICreateRulesetOptions*) createRulesetOptions
...
-(NSURLSessionTask*) doesInboxHaveAutomationsWithCompletionHandler: 
    (void (^)(NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/automations"];
...
///
///  @returns OAIPagePlusAddressProjection*
///
-(NSURLSessionTask*) getAllPlusAddressesWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/plus-addresses"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPagePlusAddressProjection*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPagePlusAddressProjection*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getImapAccessWithInboxId: (NSString*) inboxId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/imap-access"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIImapAccessDetails*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIImapAccessDetails*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getImapSmtpAccessEnvWithInboxId: (NSString*) inboxId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/imap-smtp-access/env"];
...
///  @returns OAIImapSmtpAccessServers*
///
-(NSURLSessionTask*) getImapSmtpAccessServersWithCompletionHandler: 
    (void (^)(OAIImapSmtpAccessServers* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/imap-smtp-access/servers"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIImapSmtpAccessServers*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIImapSmtpAccessServers*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getInboxPlusAddressWithPlusAddressId: (NSString*) plusAddressId
    ...
    if (plusAddressId == nil) {
        NSParameterAssert(plusAddressId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"plusAddressId"] };
            NSError* error = [NSError errorWithDomain:kOAIInboxControllerApiErrorDomain code:kOAIInboxControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/{inboxId}/plus-addresses/{plusAddressId}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (plusAddressId != nil) {
        pathParams[@"plusAddressId"] = plusAddressId;
    }
    if (inboxId != nil) {
        pathParams[@"inboxId"] = inboxId;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPlusAddressDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPlusAddressDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getInboxPlusAddressByIdWithPlusAddressId: (NSString*) plusAddressId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/plus-addresses/{plusAddressId}"];
...
-(NSURLSessionTask*) getInboxPlusAddressEmailsWithPlusAddress: (NSString*) plusAddress
    ...
    if (plusAddress == nil) {
        NSParameterAssert(plusAddress);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"plusAddress"] };
            NSError* error = [NSError errorWithDomain:kOAIInboxControllerApiErrorDomain code:kOAIInboxControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/{inboxId}/plus-addresses/emails"];
    ...
    NSMutableDictionary* queryParams = [[NSMutableDictionary alloc] init];
    if (plusAddress != nil) {
        queryParams[@"plusAddress"] = plusAddress;
    }
    if (page != nil) {
        queryParams[@"page"] = page;
    }
...
-(NSURLSessionTask*) getInboxPlusAddressEmailsForPlusAddressIdWithPlusAddressId: (NSString*) plusAddressId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails"];
...
-(NSURLSessionTask*) getInboxPlusAddressesWithInboxId: (NSString*) inboxId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/{inboxId}/plus-addresses"];
...
-(NSURLSessionTask*) getInboxSentCountWithInboxId: (NSString*) inboxId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/{inboxId}/sent/count"];
...
-(NSURLSessionTask*) getInboxTagsPaginatedWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/tags/paginated"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPageInboxTags*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPageInboxTags*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getInboxesByTagWithTag: (NSString*) tag
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/tags/inboxes"];
...
///  @returns OAIPlusAddressDto*
///
-(NSURLSessionTask*) getOrCreateInboxPlusAddressWithInboxId: (NSString*) inboxId
    ...
    if (fullAddress == nil) {
        NSParameterAssert(fullAddress);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"fullAddress"] };
            NSError* error = [NSError errorWithDomain:kOAIInboxControllerApiErrorDomain code:kOAIInboxControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/{inboxId}/plus-addresses/get-or-create"];
...
///  @returns OAIPlusAddressDto*
///
-(NSURLSessionTask*) getOrCreatePlusAddressByFullAddressWithFullAddress: (NSString*) fullAddress
    completionHandler: (void (^)(OAIPlusAddressDto* output, NSError* error)) handler {
    // verify the required parameter 'fullAddress' is set
    if (fullAddress == nil) {
        NSParameterAssert(fullAddress);
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/get-or-create-plus-address"];
...
-(NSURLSessionTask*) getOutboxesWithPage: (NSNumber*) page
    ...
    sort: (NSString*) sort
    completionHandler: (void (^)(OAIPageInboxProjection* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/outboxes"];
...
-(NSURLSessionTask*) getSmtpAccessWithInboxId: (NSString*) inboxId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/smtp-access"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAISmtpAccessDetails*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAISmtpAccessDetails*)data, error);
                                }
                            }];
}
...
///  @param emailAddress  
///
///  @returns OAIEmailAvailableResult*
///
-(NSURLSessionTask*) isEmailAddressAvailableWithEmailAddress: (NSString*) emailAddress
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/inboxes/available"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIEmailAvailableResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIEmailAvailableResult*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) updateImapAccessWithUpdateImapAccessOptions: (OAIUpdateImapAccessOptions*) updateImapAccessOptions
    ...
    if (updateImapAccessOptions == nil) {
        NSParameterAssert(updateImapAccessOptions);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"updateImapAccessOptions"] };
            NSError* error = [NSError errorWithDomain:kOAIInboxControllerApiErrorDomain code:kOAIInboxControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = updateImapAccessOptions;
...
-(NSURLSessionTask*) updateSmtpAccessWithUpdateSmtpAccessOptions: (OAIUpdateSmtpAccessOptions*) updateSmtpAccessOptions
    ...
    if (updateSmtpAccessOptions == nil) {
        NSParameterAssert(updateSmtpAccessOptions);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"updateSmtpAccessOptions"] };
            NSError* error = [NSError errorWithDomain:kOAIInboxControllerApiErrorDomain code:kOAIInboxControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = updateSmtpAccessOptions;
