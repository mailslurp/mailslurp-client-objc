...
#import "OAIAITransformMappingMatchResult.h"
...
#import "OAIExportTransformerResponse.h"
#import "OAIExportTransformerResultJobDto.h"
...
///
///  @returns OAIExportTransformerResponse*
///
-(NSURLSessionTask*) exportTransformerResultsWithExportTransformerOptions: (OAIExportTransformerOptions*) exportTransformerOptions
    ...
    if (exportTransformerOptions == nil) {
        NSParameterAssert(exportTransformerOptions);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"exportTransformerOptions"] };
            NSError* error = [NSError errorWithDomain:kOAIAIControllerApiErrorDomain code:kOAIAIControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ai/transformer/results/export"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = exportTransformerOptions;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIExportTransformerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIExportTransformerResponse*)data, error);
                                }
                            }];
}
...
///  @param _id  
///
///  @returns OAIExportTransformerResultJobDto*
///
-(NSURLSessionTask*) getExportTransformerResultsJobWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ai/transformer/results/export/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIExportTransformerResultJobDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIExportTransformerResultJobDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getTransformerResultsTableWithIncludeMetaData: (NSNumber*) includeMetaData
    ...
    if (includeMetaData == nil) {
        NSParameterAssert(includeMetaData);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"includeMetaData"] };
            NSError* error = [NSError errorWithDomain:kOAIAIControllerApiErrorDomain code:kOAIAIControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    if (flattenArraysToRows == nil) {
        NSParameterAssert(flattenArraysToRows);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"flattenArraysToRows"] };
            NSError* error = [NSError errorWithDomain:kOAIAIControllerApiErrorDomain code:kOAIAIControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ai/transformer/results/table"];
    ...
    if (includeMetaData != nil) {
        queryParams[@"includeMetaData"] = [includeMetaData isEqual:@(YES)] ? @"true" : @"false";
    }
    if (flattenArraysToRows != nil) {
        queryParams[@"flattenArraysToRows"] = [flattenArraysToRows isEqual:@(YES)] ? @"true" : @"false";
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPageTableData*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPageTableData*)data, error);
                                }
                            }];
}
...
///  @param attachmentId  (optional)
///
///  @returns OAIAITransformMappingMatchResult*
///
-(NSURLSessionTask*) testTransformerMappingMatchWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ai/transformer/mappings/{id}/match"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIAITransformMappingMatchResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIAITransformMappingMatchResult*)data, error);
                                }
                            }];
}
