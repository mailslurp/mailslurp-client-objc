...
///
///  @returns OAITestInboxRulesetReceivingResult*
///
-(NSURLSessionTask*) testInboxRulesetReceivingWithTestInboxRulesetReceivingOptions: (OAITestInboxRulesetReceivingOptions*) testInboxRulesetReceivingOptions
    ...
    if (testInboxRulesetReceivingOptions == nil) {
        NSParameterAssert(testInboxRulesetReceivingOptions);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"testInboxRulesetReceivingOptions"] };
            NSError* error = [NSError errorWithDomain:kOAIInboxRulesetControllerApiErrorDomain code:kOAIInboxRulesetControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = testInboxRulesetReceivingOptions;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAITestInboxRulesetReceivingResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAITestInboxRulesetReceivingResult*)data, error);
                                }
                            }];
}
...
///
///  @returns OAITestInboxRulesetSendingResult*
///
-(NSURLSessionTask*) testInboxRulesetSendingWithTestInboxRulesetSendingOptions: (OAITestInboxRulesetSendingOptions*) testInboxRulesetSendingOptions
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAITestInboxRulesetSendingResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAITestInboxRulesetSendingResult*)data, error);
                                }
                            }];
}
