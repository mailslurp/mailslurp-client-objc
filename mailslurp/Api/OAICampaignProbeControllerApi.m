...
#import "OAICampaignProbeRunComparisonDto.h"
...
///  @param otherRunId  
///
///  @returns OAICampaignProbeRunComparisonDto*
///
-(NSURLSessionTask*) compareCampaignProbeRunsWithProbeId: (NSString*) probeId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaign-probe/probes/{probeId}/runs/{runId}/compare/{otherRunId}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAICampaignProbeRunComparisonDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAICampaignProbeRunComparisonDto*)data, error);
                                }
                            }];
}
...
///  @param runId  
///
///  @returns OAICampaignProbeRunDto*
///
-(NSURLSessionTask*) getCampaignProbeRunWithProbeId: (NSString*) probeId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaign-probe/probes/{probeId}/runs/{runId}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAICampaignProbeRunDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAICampaignProbeRunDto*)data, error);
                                }
                            }];
}
