...
///  @param deliveryId  
///
///  @returns OAIDeliveryStatus*
///
-(NSURLSessionTask*) getSentDeliveryStatusWithDeliveryId: (NSString*) deliveryId
    completionHandler: (void (^)(OAIDeliveryStatus* output, NSError* error)) handler {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIDeliveryStatus*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIDeliveryStatus*)data, error);
                                }
                            }];
}
