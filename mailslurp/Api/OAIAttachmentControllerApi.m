...
///
///  @returns OAIExtractAttachmentTextResult*
///
-(NSURLSessionTask*) extractAttachmentTextWithAttachmentId: (NSString*) attachmentId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/attachments/{attachmentId}/text"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = extractAttachmentTextOptions;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIExtractAttachmentTextResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIExtractAttachmentTextResult*)data, error);
                                }
                            }];
}
