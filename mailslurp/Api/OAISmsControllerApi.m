...
-(NSURLSessionTask*) getSmsCodesWithSmsId: (NSString*) smsId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/{smsId}/codes"];
...
///  @param read  (optional, default to @(YES))
///
///  @param phoneNumberId  (optional)
///
///  @returns void
...
-(NSURLSessionTask*) markAllSmsAsReadWithRead: (NSNumber*) read
    ...
    completionHandler: (void (^)(NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/read"];
...
-(NSURLSessionTask*) markSmsAsReadWithSmsId: (NSString*) smsId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/sms/{smsId}/read"];
