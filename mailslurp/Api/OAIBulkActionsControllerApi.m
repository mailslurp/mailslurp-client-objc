#import "OAIBulkActionsControllerApi.h"
...
@interface OAIBulkActionsControllerApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIBulkActionsControllerApi

NSString* kOAIBulkActionsControllerApiErrorDomain = @"OAIBulkActionsControllerApiErrorDomain";
NSInteger kOAIBulkActionsControllerApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) bulkCreateInboxesWithCount: (NSNumber*) count
    ...
    if (count == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIBulkActionsControllerApiErrorDomain code:kOAIBulkActionsControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
