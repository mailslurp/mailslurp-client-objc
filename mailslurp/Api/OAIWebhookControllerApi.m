...
#import "OAIPageWebhookEndpointProjection.h"
...
-(NSURLSessionTask*) createWebhookForAITransformerWithTransformerId: (NSString*) transformerId
    ...
    if (transformerId == nil) {
        NSParameterAssert(transformerId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"transformerId"] };
            NSError* error = [NSError errorWithDomain:kOAIWebhookControllerApiErrorDomain code:kOAIWebhookControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ai-transformers/{transformerId}/webhooks"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (transformerId != nil) {
        pathParams[@"transformerId"] = transformerId;
    }
...
///  @param eventType Optional event type (optional)
///
///  @returns OAIPageWebhookEndpointProjection*
///
-(NSURLSessionTask*) getAllWebhookEndpointsWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/webhooks/endpoints"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPageWebhookEndpointProjection*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPageWebhookEndpointProjection*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getAllWebhookResultsWithPage: (NSNumber*) page
    ...
    if (aiTransformerId != nil) {
        queryParams[@"aiTransformerId"] = aiTransformerId;
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
...
-(NSURLSessionTask*) getAllWebhooksWithPage: (NSNumber*) page
    ...
    if (eventTypeSource != nil) {
        queryParams[@"eventTypeSource"] = eventTypeSource;
    }
    if (includeAccountWide != nil) {
        queryParams[@"includeAccountWide"] = [includeAccountWide isEqual:@(YES)] ? @"true" : @"false";
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
...
/// 
///  @returns OAIWebhookNewAITransformResultPayload*
///
-(NSURLSessionTask*) getTestWebhookPayloadNewAITransformResultWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/webhooks/test/new-ai-transform-result-payload"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIWebhookNewAITransformResultPayload*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIWebhookNewAITransformResultPayload*)data, error);
                                }
                            }];
}
...
///  @param sort Optional createdAt sort direction ASC or DESC (optional, default to @"ASC")
///
///  @returns NSArray<OAIWebhookProjection>*
///
-(NSURLSessionTask*) getWebhooksWithInboxId: (NSString*) inboxId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAIWebhookProjection>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAIWebhookProjection>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) updateWebhookWithWebhookId: (NSString*) webhookId
    ...
    if (overrideAuth != nil) {
        queryParams[@"overrideAuth"] = [overrideAuth isEqual:@(YES)] ? @"true" : @"false";
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
