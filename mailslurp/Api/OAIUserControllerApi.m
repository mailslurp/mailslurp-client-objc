...
#import "OAICreateInboxRetentionPolicyForAccountOptions.h"
#import "OAIEmptyResponseDto.h"
#import "OAIInboxRetentionPolicyDto.h"
#import "OAIInboxRetentionPolicyOptionalDto.h"
...
///
///  @returns OAIInboxRetentionPolicyDto*
///
-(NSURLSessionTask*) createOrUpdateInboxRetentionPolicyForAccountWithCreateInboxRetentionPolicyForAccountOptions: (OAICreateInboxRetentionPolicyForAccountOptions*) createInboxRetentionPolicyForAccountOptions
    ...
    if (createInboxRetentionPolicyForAccountOptions == nil) {
        NSParameterAssert(createInboxRetentionPolicyForAccountOptions);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"createInboxRetentionPolicyForAccountOptions"] };
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/user/inbox-retention-policies/account"];
    ...
    bodyParam = createInboxRetentionPolicyForAccountOptions;
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIInboxRetentionPolicyDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIInboxRetentionPolicyDto*)data, error);
                                }
                            }];
}
...
///  @returns OAIInboxRetentionPolicyOptionalDto*
///
-(NSURLSessionTask*) getInboxRetentionPolicyForAccountWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIInboxRetentionPolicyOptionalDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIInboxRetentionPolicyOptionalDto*)data, error);
                                }
                            }];
}
