...
#import "OAITenantReputationFindingsDto.h"
#import "OAITenantReputationStatusSummaryDto.h"
...
///
///  @returns OAITenantReputationFindingsDto*
///
-(NSURLSessionTask*) getTenantReputationFindingsWithAccountRegion: (NSString*) accountRegion
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/bounce/tenant-findings"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];

    NSMutableDictionary* queryParams = [[NSMutableDictionary alloc] init];
    if (accountRegion != nil) {
        queryParams[@"accountRegion"] = accountRegion;
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAITenantReputationFindingsDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAITenantReputationFindingsDto*)data, error);
                                }
                            }];
}
...
///  @param accountRegion Optional account region filter (optional)
///
///  @returns OAITenantReputationStatusSummaryDto*
///
-(NSURLSessionTask*) getTenantReputationStatusSummaryWithAccountRegion: (NSString*) accountRegion
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/bounce/tenant-status"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAITenantReputationStatusSummaryDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAITenantReputationStatusSummaryDto*)data, error);
                                }
                            }];
}
