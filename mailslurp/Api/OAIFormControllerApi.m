...
-(NSURLSessionTask*) submitFormWithTo: (NSString*) to
    ...
    if (subject != nil) {
        queryParams[@"_subject"] = subject;
    }
    if (redirectTo != nil) {
        queryParams[@"_redirectTo"] = redirectTo;
    }
    if (emailAddress != nil) {
        queryParams[@"_emailAddress"] = emailAddress;
    }
    if (successMessage != nil) {
        queryParams[@"_successMessage"] = successMessage;
    }
    if (spamCheck != nil) {
        queryParams[@"_spamCheck"] = spamCheck;
    }
    if (otherParameters != nil) {
        queryParams[@"otherParameters"] = otherParameters;
    }
