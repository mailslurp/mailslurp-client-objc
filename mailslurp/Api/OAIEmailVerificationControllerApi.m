...
-(NSURLSessionTask*) deleteAllValidationRequestsWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email-verification"];
...
-(NSURLSessionTask*) deleteValidationRequestWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/email-verification/{id}"];
