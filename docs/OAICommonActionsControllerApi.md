...
[**sendEmailQuery**](OAICommonActionsControllerApi#sendemailquery) | **POST** /sendEmailQuery | Send an email using query parameters
...
NSString* prefix = @"prefix_example"; //  (optional)
...
NSString* inboxId = @"inboxId_example"; // ID of inbox to delete
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**NSString***]()| ID of inbox to delete | 
...
NSString* inboxId = @"inboxId_example"; // ID of inbox to empty
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**NSString***]()| ID of inbox to empty | 
...
NSString* to = @"to_example"; // Email address to send to
NSString* senderId = @"senderId_example"; // ID of inbox to send from. If null an inbox will be created for sending (optional)
NSString* body = @"body_example"; // Body of the email message. Supports HTML (optional)
NSString* subject = @"subject_example"; // Subject line of the email (optional)

OAICommonActionsControllerApi*apiInstance = [[OAICommonActionsControllerApi alloc] init];

// Send an email using query parameters
[apiInstance sendEmailQueryWithTo:to
              senderId:senderId
              body:body
              subject:subject
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling OAICommonActionsControllerApi->sendEmailQuery: %@", error);
                        }
                    }];
```
