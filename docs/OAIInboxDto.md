...
**userId** | **NSString*** | ID of user that inbox belongs to | 
...
**localPart** | **NSString*** | Local part of email addresses before the @ symbol | [optional] 
**domain** | **NSString*** | Domain name of the email address | [optional] 
**accountRegion** | **NSString*** | Region of the inbox | [optional] 
