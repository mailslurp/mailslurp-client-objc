...
------------- | ------------- | -------------
[**createTransformer**](OAIAIControllerApi#createtransformer) | **POST** /ai/transformer | Create a transformer for reuse in automations
...
[**deleteAllTransformerMappings**](OAIAIControllerApi#deletealltransformermappings) | **DELETE** /ai/transformer/mappings | Delete all transformer mapping
...
[**exportTransformerResults**](OAIAIControllerApi#exporttransformerresults) | **POST** /ai/transformer/results/export | Export transformer results
...
[**getExportTransformerResultsJob**](OAIAIControllerApi#getexporttransformerresultsjob) | **POST** /ai/transformer/results/export/{id} | Get export transformer results job
...
[**getTransformerResultsTable**](OAIAIControllerApi#gettransformerresultstable) | **GET** /ai/transformer/results/table | Get transformer results table
[**getTransformers**](OAIAIControllerApi#gettransformers) | **GET** /ai/transformer | List transformers
[**invokeTransformer**](OAIAIControllerApi#invoketransformer) | **POST** /ai/transformer/invoke | Invoke a transformer
[**testTransformerMappingMatch**](OAIAIControllerApi#testtransformermappingmatch) | **POST** /ai/transformer/mappings/{id}/match | Test transformer mapping match result
...
OAIAITransformCreateOptions* aITransformCreateOptions = [[OAIAITransformCreateOptions alloc] init]; // 

OAIAIControllerApi*apiInstance = [[OAIAIControllerApi alloc] init];

// Create a transformer for reuse in automations
[apiInstance createTransformerWithAITransformCreateOptions:aITransformCreateOptions
...
------------- | ------------- | ------------- | -------------
 **aITransformCreateOptions** | [**OAIAITransformCreateOptions***](OAIAITransformCreateOptions)|  | 
...
// Delete all transformer mapping
[apiInstance deleteAllTransformerMappingsWithCompletionHandler: 
          ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->deleteAllTransformerMappings: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) exportTransformerResultsWithExportTransformerOptions: (OAIExportTransformerOptions*) exportTransformerOptions
        completionHandler: (void (^)(OAIExportTransformerResponse* output, NSError* error)) handler;
```
...
OAIExportTransformerOptions* exportTransformerOptions = [[OAIExportTransformerOptions alloc] init]; // 

OAIAIControllerApi*apiInstance = [[OAIAIControllerApi alloc] init];

// Export transformer results
[apiInstance exportTransformerResultsWithExportTransformerOptions:exportTransformerOptions
          completionHandler: ^(OAIExportTransformerResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->exportTransformerResults: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **exportTransformerOptions** | [**OAIExportTransformerOptions***](OAIExportTransformerOptions)|  | 

### Return type

[**OAIExportTransformerResponse***](OAIExportTransformerResponse)
...
```objc
-(NSURLSessionTask*) getExportTransformerResultsJobWithId: (NSString*) _id
        completionHandler: (void (^)(OAIExportTransformerResultJobDto* output, NSError* error)) handler;
```
...
// Get export transformer results job
[apiInstance getExportTransformerResultsJobWithId:_id
          completionHandler: ^(OAIExportTransformerResultJobDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->getExportTransformerResultsJob: %@", error);
                        }
                    }];
```
...
[**OAIExportTransformerResultJobDto***](OAIExportTransformerResultJobDto)
...
```objc
-(NSURLSessionTask*) getTransformerResultsWithEmailId: (NSString*) emailId
    smsId: (NSString*) smsId
    attachmentId: (NSString*) attachmentId
    aiTransformId: (NSString*) aiTransformId
...
NSString* smsId = @"smsId_example"; //  (optional)
NSString* attachmentId = @"attachmentId_example"; //  (optional)
NSString* aiTransformId = @"aiTransformId_example"; //  (optional)
...
// Get transformer results
[apiInstance getTransformerResultsWithEmailId:emailId
              smsId:smsId
...
```objc
-(NSURLSessionTask*) getTransformerResultsTableWithIncludeMetaData: (NSNumber*) includeMetaData
    flattenArraysToRows: (NSNumber*) flattenArraysToRows
    ...
    size: (NSNumber*) size
    sort: (NSString*) sort
        completionHandler: (void (^)(OAIPageTableData* output, NSError* error)) handler;
```
...
NSNumber* includeMetaData = @56; // 
NSNumber* flattenArraysToRows = @56; // 
NSString* emailId = @"emailId_example"; //  (optional)
NSString* smsId = @"smsId_example"; //  (optional)
NSString* attachmentId = @"attachmentId_example"; //  (optional)
NSString* aiTransformId = @"aiTransformId_example"; //  (optional)
...
// Get transformer results table
[apiInstance getTransformerResultsTableWithIncludeMetaData:includeMetaData
              ...
              size:size
              sort:sort
          completionHandler: ^(OAIPageTableData* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->getTransformerResultsTable: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **includeMetaData** | **NSNumber***|  | 
 **flattenArraysToRows** | **NSNumber***|  | 
 **emailId** | [**NSString***]()|  | [optional] 
 **smsId** | [**NSString***]()|  | [optional] 
 **attachmentId** | **NSString***|  | [optional] 
 **aiTransformId** | [**NSString***]()|  | [optional] 
...
[**OAIPageTableData***](OAIPageTableData)
...
// List transformers
[apiInstance getTransformersWithPage:page
              size:size
              sort:sort
              include:include
          completionHandler: ^(OAIPageAITransformProjection* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->getTransformers: %@", error);
                        }
                    }];
```
...
OAIInvokeTransformerOptions* invokeTransformerOptions = [[OAIInvokeTransformerOptions alloc] init]; // 

OAIAIControllerApi*apiInstance = [[OAIAIControllerApi alloc] init];

// Invoke a transformer
[apiInstance invokeTransformerWithInvokeTransformerOptions:invokeTransformerOptions
          completionHandler: ^(OAIConditionalStructuredContentResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->invokeTransformer: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **invokeTransformerOptions** | [**OAIInvokeTransformerOptions***](OAIInvokeTransformerOptions)|  | 

### Return type

[**OAIConditionalStructuredContentResult***](OAIConditionalStructuredContentResult)
...
```objc
-(NSURLSessionTask*) testTransformerMappingMatchWithId: (NSString*) _id
    emailId: (NSString*) emailId
    smsId: (NSString*) smsId
    attachmentId: (NSString*) attachmentId
        completionHandler: (void (^)(OAIAITransformMappingMatchResult* output, NSError* error)) handler;
```
...
// Test transformer mapping match result
[apiInstance testTransformerMappingMatchWithId:_id
              emailId:emailId
              smsId:smsId
              attachmentId:attachmentId
          completionHandler: ^(OAIAITransformMappingMatchResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIAIControllerApi->testTransformerMappingMatch: %@", error);
                        }
                    }];
```
...
[**OAIAITransformMappingMatchResult***](OAIAITransformMappingMatchResult)
