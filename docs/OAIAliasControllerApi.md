...
[**getAliasEmails**](OAIAliasControllerApi.md#getaliasemails) | **GET** /aliases/{aliasId}/emails | Get emails for an alias
[**getAliasThreads**](OAIAliasControllerApi.md#getaliasthreads) | **GET** /aliases/{aliasId}/threads | Get threads created for an alias
[**getAliases**](OAIAliasControllerApi.md#getaliases) | **GET** /aliases | Get all email aliases you have created
[**replyToEmail**](OAIAliasControllerApi.md#replytoemail) | **PUT** /aliases/{aliasId}/emails/{emailId} | Reply to an email
[**sendAliasEmail**](OAIAliasControllerApi.md#sendaliasemail) | **POST** /aliases/{aliasId}/emails | Send an email from an alias inbox
...
[**OAIPageThreadProjection***](OAIPageThreadProjection.md)
...
# **replyToEmail**
```objc
-(NSURLSessionTask*) replyToEmailWithAliasId: (NSString*) aliasId
...
// Reply to an email
[apiInstance replyToEmailWithAliasId:aliasId
              emailId:emailId
          ...
          completionHandler: ^(OAISentEmailDto* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIAliasControllerApi->replyToEmail: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **aliasId** | [**NSString***](.md)| ID of the alias that email belongs to | 
 **emailId** | [**NSString***](.md)| ID of the email that should be replied to | 
 **replyToAliasEmailOptions** | [**OAIReplyToAliasEmailOptions***](OAIReplyToAliasEmailOptions.md)| replyToAliasEmailOptions | 
...
------------- | ------------- | ------------- | -------------
 **aliasId** | [**NSString***](.md)| aliasId | 
 **sendEmailOptions** | [**OAISendEmailOptions***](OAISendEmailOptions.md)| Options for the email to be sent | [optional] 
