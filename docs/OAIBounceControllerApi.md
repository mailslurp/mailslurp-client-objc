...
[**getReputationItems**](OAIBounceControllerApi#getreputationitems) | **GET** /bounce/reputation-items | Get paginated list of reputation items.
[**getTenantReputationFindings**](OAIBounceControllerApi#gettenantreputationfindings) | **GET** /bounce/tenant-findings | Get SES tenant reputation findings
[**getTenantReputationStatusSummary**](OAIBounceControllerApi#gettenantreputationstatussummary) | **GET** /bounce/tenant-status | Get SES tenant status summary
...
// Get paginated list of reputation items.
[apiInstance getReputationItemsWithPage:page
              size:size
              sort:sort
              since:since
              before:before
          completionHandler: ^(OAIPageReputationItems* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIBounceControllerApi->getReputationItems: %@", error);
                        }
                    }];
```
...
[**OAIPageReputationItems***](OAIPageReputationItems)
...
```objc
-(NSURLSessionTask*) getTenantReputationFindingsWithAccountRegion: (NSString*) accountRegion
        completionHandler: (void (^)(OAITenantReputationFindingsDto* output, NSError* error)) handler;
```
...
NSString* accountRegion = @"accountRegion_example"; // Optional account region filter (optional)

OAIBounceControllerApi*apiInstance = [[OAIBounceControllerApi alloc] init];

// Get SES tenant reputation findings
[apiInstance getTenantReputationFindingsWithAccountRegion:accountRegion
          completionHandler: ^(OAITenantReputationFindingsDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIBounceControllerApi->getTenantReputationFindings: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **accountRegion** | **NSString***| Optional account region filter | [optional] 

### Return type

[**OAITenantReputationFindingsDto***](OAITenantReputationFindingsDto)
...
```objc
-(NSURLSessionTask*) getTenantReputationStatusSummaryWithAccountRegion: (NSString*) accountRegion
        completionHandler: (void (^)(OAITenantReputationStatusSummaryDto* output, NSError* error)) handler;
```
...
// Get SES tenant status summary
[apiInstance getTenantReputationStatusSummaryWithAccountRegion:accountRegion
          completionHandler: ^(OAITenantReputationStatusSummaryDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIBounceControllerApi->getTenantReputationStatusSummary: %@", error);
                        }
                    }];
```
...
[**OAITenantReputationStatusSummaryDto***](OAITenantReputationStatusSummaryDto)
