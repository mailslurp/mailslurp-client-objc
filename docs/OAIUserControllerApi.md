...
------------- | ------------- | -------------
[**createOrUpdateInboxRetentionPolicyForAccount**](OAIUserControllerApi#createorupdateinboxretentionpolicyforaccount) | **POST** /user/inbox-retention-policies/account | 
[**deleteInboxRetentionPolicyForAccount**](OAIUserControllerApi#deleteinboxretentionpolicyforaccount) | **DELETE** /user/inbox-retention-policies/account | 
...
[**getInboxRetentionPolicyForAccount**](OAIUserControllerApi#getinboxretentionpolicyforaccount) | **GET** /user/inbox-retention-policies/account | 
...
```objc
-(NSURLSessionTask*) createOrUpdateInboxRetentionPolicyForAccountWithCreateInboxRetentionPolicyForAccountOptions: (OAICreateInboxRetentionPolicyForAccountOptions*) createInboxRetentionPolicyForAccountOptions
        completionHandler: (void (^)(OAIInboxRetentionPolicyDto* output, NSError* error)) handler;
```
...
OAICreateInboxRetentionPolicyForAccountOptions* createInboxRetentionPolicyForAccountOptions = [[OAICreateInboxRetentionPolicyForAccountOptions alloc] init]; // 

OAIUserControllerApi*apiInstance = [[OAIUserControllerApi alloc] init];

[apiInstance createOrUpdateInboxRetentionPolicyForAccountWithCreateInboxRetentionPolicyForAccountOptions:createInboxRetentionPolicyForAccountOptions
          completionHandler: ^(OAIInboxRetentionPolicyDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIUserControllerApi->createOrUpdateInboxRetentionPolicyForAccount: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **createInboxRetentionPolicyForAccountOptions** | [**OAICreateInboxRetentionPolicyForAccountOptions***](OAICreateInboxRetentionPolicyForAccountOptions)|  | 

### Return type

[**OAIInboxRetentionPolicyDto***](OAIInboxRetentionPolicyDto)
...
```objc
-(NSURLSessionTask*) deleteInboxRetentionPolicyForAccountWithCompletionHandler: 
        (void (^)(OAIEmptyResponseDto* output, NSError* error)) handler;
```
...
[apiInstance deleteInboxRetentionPolicyForAccountWithCompletionHandler: 
          ^(OAIEmptyResponseDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIUserControllerApi->deleteInboxRetentionPolicyForAccount: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getInboxRetentionPolicyForAccountWithCompletionHandler: 
        (void (^)(OAIInboxRetentionPolicyOptionalDto* output, NSError* error)) handler;
```
...
[apiInstance getInboxRetentionPolicyForAccountWithCompletionHandler: 
          ^(OAIInboxRetentionPolicyOptionalDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIUserControllerApi->getInboxRetentionPolicyForAccount: %@", error);
                        }
                    }];
```
...
[**OAIInboxRetentionPolicyOptionalDto***](OAIInboxRetentionPolicyOptionalDto)
