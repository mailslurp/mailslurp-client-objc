...
[**markAsRead**](OAIEmailControllerApi#markasread) | **PATCH** /emails/{emailId}/read | Mark an email as read on unread
...
// Get email count
[apiInstance getEmailCountWithCompletionHandler: 
...
# **getEmailsPaginated**
```objc
-(NSURLSessionTask*) getEmailsPaginatedWithBefore: (NSDate*) before
    inboxId: (NSArray<NSString*>*) inboxId
    page: (NSNumber*) page
...
// Get all emails in all inboxes in paginated form. Email API list all.
[apiInstance getEmailsPaginatedWithBefore:before
              inboxId:inboxId
              page:page
...
```objc
-(NSURLSessionTask*) getOrganizationEmailsPaginatedWithBefore: (NSDate*) before
    inboxId: (NSArray<NSString*>*) inboxId
    page: (NSNumber*) page
    searchFilter: (NSString*) searchFilter
    since: (NSDate*) since
...
// Get all organization emails. List team or shared test email accounts
[apiInstance getOrganizationEmailsPaginatedWithBefore:before
              inboxId:inboxId
              page:page
              searchFilter:searchFilter
              since:since
