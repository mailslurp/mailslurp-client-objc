...
[**getLatestEmail**](OAIEmailControllerApi.md#getlatestemail) | **GET** /emails/latest | Get latest email
[**getLatestEmailInInbox**](OAIEmailControllerApi.md#getlatestemailininbox) | **GET** /emails/latestIn | Get latest email
[**getOrganizationEmailsPaginated**](OAIEmailControllerApi.md#getorganizationemailspaginated) | **GET** /emails/organization | Get all organization emails
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxIds** | [**NSArray&lt;NSString*&gt;***](NSString*.md)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | [optional] 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**NSString***](.md)| ID of the inbox you want to get the latest email from | [optional] 
