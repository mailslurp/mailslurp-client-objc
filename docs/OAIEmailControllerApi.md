...
[**canSend**](OAIEmailControllerApi#cansend) | **POST** /emails/can-send | Check whether an email send would be accepted
[**checkEmailAudit1**](OAIEmailControllerApi#checkemailaudit1) | **POST** /emails/{emailId}/check-email-audit | Run aggregate email audit for a stored email
[**checkEmailBody**](OAIEmailControllerApi#checkemailbody) | **POST** /emails/{emailId}/check-email-body | Check email body for broken links, images, and spelling issues
[**checkEmailBodyFeatureSupport**](OAIEmailControllerApi#checkemailbodyfeaturesupport) | **POST** /emails/{emailId}/check-email-body-feature-support | Check client support for features used in a stored email body
[**checkEmailClientSupport**](OAIEmailControllerApi#checkemailclientsupport) | **POST** /emails/check-email-client-support | Check email-client support for a provided HTML body
[**createEmailAuditForEmail**](OAIEmailControllerApi#createemailauditforemail) | **POST** /emails/{emailId}/audit | Persist aggregate email audit for a stored email
...
[**getEmail**](OAIEmailControllerApi#getemail) | **GET** /emails/{emailId} | Get hydrated email (headers and body)
[**getEmailAttachments**](OAIEmailControllerApi#getemailattachments) | **GET** /emails/{emailId}/attachments | List attachment metadata for an email
[**getEmailCodes**](OAIEmailControllerApi#getemailcodes) | **POST** /emails/{emailId}/codes | Extract verification codes from an email
[**getEmailContentMatch**](OAIEmailControllerApi#getemailcontentmatch) | **POST** /emails/{emailId}/contentMatch | Run regex against hydrated email body and return matches
...
[**getEmailContentPartContent**](OAIEmailControllerApi#getemailcontentpartcontent) | **GET** /emails/{emailId}/contentPart/raw | Get multipart content part as raw response
[**getEmailCount**](OAIEmailControllerApi#getemailcount) | **GET** /emails/emails/count | Get email count
[**getEmailHTML**](OAIEmailControllerApi#getemailhtml) | **GET** /emails/{emailId}/html | Get hydrated email HTML for browser rendering
[**getEmailHTMLJson**](OAIEmailControllerApi#getemailhtmljson) | **GET** /emails/{emailId}/html/json | Get hydrated email HTML wrapped in JSON
[**getEmailHTMLQuery**](OAIEmailControllerApi#getemailhtmlquery) | **GET** /emails/{emailId}/htmlQuery | Query hydrated HTML body and return matching text lines
[**getEmailLinks**](OAIEmailControllerApi#getemaillinks) | **GET** /emails/{emailId}/links | Extract links from an email HTML body
...
[**getEmailSignature**](OAIEmailControllerApi#getemailsignature) | **GET** /emails/{emailId}/signature | Extract signature from an inbound email
[**getEmailSummary**](OAIEmailControllerApi#getemailsummary) | **GET** /emails/{emailId}/summary | Get email summary (headers/metadata only)
[**getEmailTextLines**](OAIEmailControllerApi#getemailtextlines) | **GET** /emails/{emailId}/textLines | Extract normalized text lines from email body
[**getEmailThread**](OAIEmailControllerApi#getemailthread) | **GET** /emails/threads/{threadId} | Get email thread metadata by thread ID
[**getEmailThreadItems**](OAIEmailControllerApi#getemailthreaditems) | **GET** /emails/threads/{threadId}/items | Get messages in a specific email thread
[**getEmailThreads**](OAIEmailControllerApi#getemailthreads) | **GET** /emails/threads | List email threads in paginated form
...
[**getGravatarUrlForEmailAddress**](OAIEmailControllerApi#getgravatarurlforemailaddress) | **GET** /emails/gravatarFor | Get Gravatar URL for an email address
...
[**getOrganizationEmailsPaginated**](OAIEmailControllerApi#getorganizationemailspaginated) | **GET** /emails/organization | List organization-visible emails
...
# **checkEmailAudit1**
```objc
-(NSURLSessionTask*) checkEmailAudit1WithEmailId: (NSString*) emailId
...
// Run aggregate email audit for a stored email
[apiInstance checkEmailAudit1WithEmailId:emailId
          completionHandler: ^(OAIEmailAuditAnalysisResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIEmailControllerApi->checkEmailAudit1: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) createEmailAuditForEmailWithEmailId: (NSString*) emailId
...
// Persist aggregate email audit for a stored email
[apiInstance createEmailAuditForEmailWithEmailId:emailId
          completionHandler: ^(OAIEmailAuditDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIEmailControllerApi->createEmailAuditForEmail: %@", error);
                        }
                    }];
```
...
NSString* emailId = @"emailId_example"; // ID of email to extract codes from
OAIExtractCodesOptions* extractCodesOptions = [[OAIExtractCodesOptions alloc] init]; //  (optional)

OAIEmailControllerApi*apiInstance = [[OAIEmailControllerApi alloc] init];

// Extract verification codes from an email
[apiInstance getEmailCodesWithEmailId:emailId
              extractCodesOptions:extractCodesOptions
          completionHandler: ^(OAIExtractCodesResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIEmailControllerApi->getEmailCodes: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**NSString***]()| ID of email to extract codes from | 
 **extractCodesOptions** | [**OAIExtractCodesOptions***](OAIExtractCodesOptions)|  | [optional] 

### Return type

[**OAIExtractCodesResult***](OAIExtractCodesResult)
...
NSString* emailId = @"emailId_example"; // ID of email to extract signature from

OAIEmailControllerApi*apiInstance = [[OAIEmailControllerApi alloc] init];

// Extract signature from an inbound email
[apiInstance getEmailSignatureWithEmailId:emailId
          completionHandler: ^(OAIEmailSignatureParseResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIEmailControllerApi->getEmailSignature: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**NSString***]()| ID of email to extract signature from | 

### Return type

[**OAIEmailSignatureParseResult***](OAIEmailSignatureParseResult)
...
NSString* emailId = @"emailId_example"; // 
NSNumber* decode = @56; // Deprecated and ignored. Retained for backwards compatibility. (optional)
...
------------- | ------------- | ------------- | -------------
 **emailId** | [**NSString***]()|  | 
 **decode** | **NSNumber***| Deprecated and ignored. Retained for backwards compatibility. | [optional] 
...
NSString* htmlSelector = @"htmlSelector_example"; // Optional inbox filter. Query parameter name is `htmlSelector` for legacy compatibility. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **htmlSelector** | [**NSString***]()| Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility. | [optional] 
 ...
 **searchFilter** | **NSString***| Optional search filter. Full email addresses match sender and receiving inbox email or receiving plus-address full address exactly. Address-like fragments containing @ (for example +alias@) also match sender, receiving inbox email, and receiving plus-address full address by contains. General text search matches sender, subject, and ID. | [optional] 
...
NSString* inboxId = @"inboxId_example"; // Inbox ID filter for unread count scope (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**NSString***]()| Inbox ID filter for unread count scope | [optional] 
