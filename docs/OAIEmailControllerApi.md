...
[**getEmailHTMLQuery**](OAIEmailControllerApi.md#getemailhtmlquery) | **POST** /emails/{emailId}/html-query | Parse and return text from an email, stripping HTML and decoding encoded characters
[**getEmailTextLines**](OAIEmailControllerApi.md#getemailtextlines) | **POST** /emails/{emailId}/text | Parse and return text from an email, stripping HTML and decoding encoded characters
...
# **getEmailTextLines**
```objc
-(NSURLSessionTask*) getEmailTextLinesWithDecodeHtmlEntities: (NSNumber*) decodeHtmlEntities
    emailId: (NSString*) emailId
        completionHandler: (void (^)(OAIEmailTextLinesResult* output, NSError* error)) handler;
```
...
NSNumber* decodeHtmlEntities = @56; // Decode HTML entities
NSString* emailId = @"emailId_example"; // ID of email to fetch text for

OAIEmailControllerApi*apiInstance = [[OAIEmailControllerApi alloc] init];

// Parse and return text from an email, stripping HTML and decoding encoded characters
[apiInstance getEmailTextLinesWithDecodeHtmlEntities:decodeHtmlEntities
              emailId:emailId
          completionHandler: ^(OAIEmailTextLinesResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **decodeHtmlEntities** | **NSNumber***| Decode HTML entities | 
