...
[**getAttachments1**](OAIEmailControllerApi#getattachments1) | **GET** /emails/{emailId}/attachments | Get all email attachment metadata. Metadata includes name and attachment size.
...
[**getEmailsPaginated**](OAIEmailControllerApi#getemailspaginated) | **GET** /emails | Get all emails in all inboxes. Email API list all.
