...
**isXAmpHtml** | **NSNumber*** | Is the email body content type x-amp-html Amp4Email? | [optional] 
**bodyPartContentTypes** | **NSArray&lt;NSString*&gt;*** | A list of detected multipart mime message body part content types such as text/plain and text/html. Can be used with email bodyPart endpoints to fetch individual body parts. | [optional] 
**externalId** | **NSString*** | UID used by external IMAP server to identify email | [optional] 
