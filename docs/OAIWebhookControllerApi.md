...
[**createWebhookForAITransformer**](OAIWebhookControllerApi#createwebhookforaitransformer) | **POST** /ai-transformers/{transformerId}/webhooks | Attach a WebHook URL to an AI transformer
...
```objc
-(NSURLSessionTask*) createWebhookForAITransformerWithTransformerId: (NSString*) transformerId
    createWebhookOptions: (OAICreateWebhookOptions*) createWebhookOptions
        completionHandler: (void (^)(OAIWebhookDto* output, NSError* error)) handler;
```
...
NSString* transformerId = @"transformerId_example"; // 
OAICreateWebhookOptions* createWebhookOptions = [[OAICreateWebhookOptions alloc] init]; // 

OAIWebhookControllerApi*apiInstance = [[OAIWebhookControllerApi alloc] init];

// Attach a WebHook URL to an AI transformer
[apiInstance createWebhookForAITransformerWithTransformerId:transformerId
              createWebhookOptions:createWebhookOptions
          completionHandler: ^(OAIWebhookDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIWebhookControllerApi->createWebhookForAITransformer: %@", error);
                        }
                    }];
```
...
-(NSURLSessionTask*) getAllWebhookResultsWithPage: (NSNumber*) page
    ...
    phoneId: (NSString*) phoneId
    aiTransformerId: (NSString*) aiTransformerId
...
NSString* aiTransformerId = @"aiTransformerId_example"; // AI Transformer ID (optional)
 ...
 **aiTransformerId** | [**NSString***]()| AI Transformer ID | [optional] 
...
-(NSURLSessionTask*) getAllWebhooksWithPage: (NSNumber*) page
    ...
    eventType: (NSString*) eventType
    url: (NSString*) url
    eventTypeSource: (NSString*) eventTypeSource
    includeAccountWide: (NSNumber*) includeAccountWide
        completionHandler: (void (^)(OAIPageWebhookProjection* output, NSError* error)) handler;
```
...
NSDate* since = @"2013-10-20T19:20:30+01:00"; // Filter by created at after the given timestamp (optional)
NSString* inboxId = @"inboxId_example"; // Filter by inboxId (optional)
NSString* aiTransformerId = @"aiTransformerId_example"; // Filter by aiTransformerId (optional)
NSString* phoneId = @"phoneId_example"; // Filter by phoneId (optional)
NSDate* before = @"2013-10-20T19:20:30+01:00"; // Filter by created at before the given timestamp (optional)
NSString* health = @"health_example"; // Filter by webhook health (optional)
NSString* eventType = @"eventType_example"; // Optional event type (optional)
NSString* url = @"url_example"; // Optional url endpoint filter (optional)
NSString* eventTypeSource = @"eventTypeSource_example"; // Webhook source type category such as phone, inbox, aiTranformer (optional)
NSNumber* includeAccountWide = @56; // Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters (optional)
 ...
 **since** | **NSDate***| Filter by created at after the given timestamp | [optional] 
 **inboxId** | [**NSString***]()| Filter by inboxId | [optional] 
 **aiTransformerId** | [**NSString***]()| Filter by aiTransformerId | [optional] 
 **phoneId** | [**NSString***]()| Filter by phoneId | [optional] 
 **before** | **NSDate***| Filter by created at before the given timestamp | [optional] 
 **health** | **NSString***| Filter by webhook health | [optional] 
 **eventType** | **NSString***| Optional event type | [optional] 
 **url** | **NSString***| Optional url endpoint filter | [optional] 
 **eventTypeSource** | **NSString***| Webhook source type category such as phone, inbox, aiTranformer | [optional] 
 **includeAccountWide** | **NSNumber***| Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters | [optional] 
...
NSString* health = @"health_example"; // Filter by webhook health (optional)
NSString* eventType = @"eventType_example"; // Optional event type (optional)
NSNumber* includeAccountWide = @56; // Include account scope inbox webhooks (optional)
 ...
 **health** | **NSString***| Filter by webhook health | [optional] 
 **eventType** | **NSString***| Optional event type | [optional] 
 **includeAccountWide** | **NSNumber***| Include account scope inbox webhooks | [optional] 
...
NSString* searchFilter = @"searchFilter_example"; // Optional search filter (optional)
NSString* health = @"health_example"; // Filter by webhook health (optional)
NSNumber* includeAccountWide = @56; // Include account scope phone webhooks (optional)
 ...
 **searchFilter** | **NSString***| Optional search filter | [optional] 
 **health** | **NSString***| Filter by webhook health | [optional] 
 **includeAccountWide** | **NSNumber***| Include account scope phone webhooks | [optional] 
...
NSString* aiTransformerId = @"aiTransformerId_example"; //  (optional)
 ...
 **aiTransformerId** | [**NSString***]()|  | [optional] 
