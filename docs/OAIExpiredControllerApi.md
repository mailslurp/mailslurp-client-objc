...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **expiredId** | [**NSString***]()| ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId | 
...
NSString* inboxId = @"inboxId_example"; // Optionally filter by inbox ID (optional)
 ...
 **inboxId** | [**NSString***]()| Optionally filter by inbox ID | [optional] 
