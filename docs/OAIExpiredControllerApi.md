...
------------- | ------------- | -------------
[**getExpirationDefaults**](OAIExpiredControllerApi.md#getexpirationdefaults) | **GET** /expired/defaults | Get default expiration settings
...
[**OAIExpirationDefaults***](OAIExpirationDefaults.md)
