...
NSNumber* teamAccess = @(NO); // DEPRECATED. Optionally filter by team access. (optional) (default to @(NO))

OAIInboxControllerApi*apiInstance = [[OAIInboxControllerApi alloc] init];

// List All Inboxes Paginated
[apiInstance getAllInboxesWithBefore:before
              favourite:favourite
              page:page
              search:search
              since:since
 ...
 **teamAccess** | **NSNumber***| DEPRECATED. Optionally filter by team access. | [optional] [default to @(NO)]
...
NSNumber* delayTimeout = @56; // delayTimeout (optional)
...
NSNumber* unreadOnly = @56; // unreadOnly (optional)
 ...
 **delayTimeout** | **NSNumber***| delayTimeout | [optional] 
 ...
 **unreadOnly** | **NSNumber***| unreadOnly | [optional] 
...
// List Inboxes and email addresses
[apiInstance getInboxesWithBefore:before
              since:since
              size:size
              sort:sort
...
// List Organization Inboxes Paginated
[apiInstance getOrganizationInboxesWithBefore:before
              page:page
              searchFilter:searchFilter
              since:since
              size:size
