...
------------- | ------------- | -------------
[**createInbox**](OAIInboxControllerApi#createinbox) | **POST** /inboxes | Create an Inbox (email address)
[**createInboxWithOptions**](OAIInboxControllerApi#createinboxwithoptions) | **POST** /inboxes/withOptions | Create an inbox with additional options
...
[**getInbox**](OAIInboxControllerApi#getinbox) | **GET** /inboxes/{inboxId} | Get Inbox
...
[**getInboxes**](OAIInboxControllerApi#getinboxes) | **GET** /inboxes | List Inboxes / Email Addresses
...
[**updateInbox**](OAIInboxControllerApi#updateinbox) | **PATCH** /inboxes/{inboxId} | Update Inbox
