...
[**createInboxWithOptions**](OAIInboxControllerApi.md#createinboxwithoptions) | **POST** /inboxes/withOptions | Create an inbox with additional options
...
[**getAllInboxes**](OAIInboxControllerApi.md#getallinboxes) | **GET** /inboxes/paginated | List All Inboxes Paginated
[**getEmails**](OAIInboxControllerApi.md#getemails) | **GET** /inboxes/{inboxId}/emails | Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
[**getExpiredInboxRecordById**](OAIInboxControllerApi.md#getexpiredinboxrecordbyid) | **GET** /inboxes/expired-records/{expiredId} | Get an expired inbox record
[**getExpiredInboxRecordByInboxId**](OAIInboxControllerApi.md#getexpiredinboxrecordbyinboxid) | **GET** /inboxes/{inboxId}/expired-record | Get expired inbox record for a previously existing inbox
[**getExpiredInboxRecords**](OAIInboxControllerApi.md#getexpiredinboxrecords) | **GET** /inboxes/expired-records | List records of expired inboxes
...
[**getInboxSentEmails**](OAIInboxControllerApi.md#getinboxsentemails) | **GET** /inboxes/{inboxId}/sent | Get Inbox Sent Emails
...
[**sendEmailAndConfirm**](OAIInboxControllerApi.md#sendemailandconfirm) | **POST** /inboxes/{inboxId}/confirm | Send email and return sent confirmation
...
NSNumber* favourite = @56; // Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering (optional)
NSString* name = @"name_example"; // Optional name of the inbox. Displayed in the dashboard for easier search (optional)
 ...
 **favourite** | **NSNumber***| Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering | [optional] 
 **name** | **NSString***| Optional name of the inbox. Displayed in the dashboard for easier search | [optional] 
 **tags** | [**NSArray&lt;NSString*&gt;***](NSString*.md)| Tags that inbox has been tagged with. Tags can be added to inboxes to group different inboxes within an account. You can also search for inboxes by tag in the dashboard UI. | [optional] 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **createInboxDto** | [**OAICreateInboxDto***](OAICreateInboxDto.md)| createInboxDto | 
...
// Get an expired inbox record
[apiInstance getExpiredInboxRecordByIdWithExpiredId:expiredId
          completionHandler: ^(OAIExpiredInboxDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getExpiredInboxRecordById: %@", error);
                        }
                    }];
```
...
// Get expired inbox record for a previously existing inbox
[apiInstance getExpiredInboxRecordByInboxIdWithInboxId:inboxId
          completionHandler: ^(OAIExpiredInboxDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getExpiredInboxRecordByInboxId: %@", error);
                        }
                    }];
```
...
// List records of expired inboxes
[apiInstance getExpiredInboxRecordsWithPage:page
              size:size
              sort:sort
          completionHandler: ^(OAIPageExpiredInboxRecordProjection* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getExpiredInboxRecords: %@", error);
                        }
                    }];
```
