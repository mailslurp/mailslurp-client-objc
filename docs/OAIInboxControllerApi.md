...
[**doesInboxHaveAutomations**](OAIInboxControllerApi#doesinboxhaveautomations) | **GET** /inboxes/automations | Does inbox have automations
...
[**getAllPlusAddresses**](OAIInboxControllerApi#getallplusaddresses) | **GET** /inboxes/plus-addresses | Get all sub address plus address aliases for an inbox
...
[**getOrCreateInboxPlusAddress**](OAIInboxControllerApi#getorcreateinboxplusaddress) | **POST** /inboxes/{inboxId}/plus-addresses/get-or-create | Get or create a plus address by full address
[**getOrCreatePlusAddressByFullAddress**](OAIInboxControllerApi#getorcreateplusaddressbyfulladdress) | **POST** /inboxes/get-or-create-plus-address | Get or create a plus address by full address without inbox ID
...
NSString* search = @"search_example"; // Optionally filter by search words partial matching name and email address (optional)
 ...
 **search** | **NSString***| Optionally filter by search words partial matching name and email address | [optional] 
...
// Get inbox tags
[apiInstance getInboxTagsWithPage:page
              size:size
              sort:sort
              searchFilter:searchFilter
...
// Get inbox tags paginated
[apiInstance getInboxTagsPaginatedWithPage:page
              size:size
              sort:sort
              searchFilter:searchFilter
          completionHandler: ^(OAIPageInboxTags* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getInboxTagsPaginated: %@", error);
                        }
                    }];
```
...
[**OAIPageInboxTags***](OAIPageInboxTags)
...
NSDate* before = @"2013-10-20T19:20:30+01:00"; // Optional filter by created before given date time (optional)
NSArray<NSString*>* include = @[@"include_example"]; // Optional inboxIds to include in result (optional)
 ...
 **before** | **NSDate***| Optional filter by created before given date time | [optional] 
 **include** | [**NSArray&lt;NSString*&gt;***](NSString*)| Optional inboxIds to include in result | [optional] 
...
NSString* tag = @"tag_example"; // Tag to filter by
NSNumber* page = @0; // Optional page index in list pagination (optional) (default to @0)
NSNumber* size = @20; // Optional page size in list pagination (optional) (default to @20)
NSString* sort = @"ASC"; // Optional createdAt sort direction ASC or DESC (optional) (default to @"ASC")
NSString* searchFilter = @"searchFilter_example"; // Optional search filter (optional)
...
// Get inboxes for a tag
[apiInstance getInboxesByTagWithTag:tag
              page:page
              size:size
              sort:sort
              searchFilter:searchFilter
          completionHandler: ^(OAIPageInboxProjection* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getInboxesByTag: %@", error);
                        }
                    }];
```
...
NSString* inboxId = @"inboxId_example"; // ID of the inbox you want to target
NSString* fullAddress = @"fullAddress_example"; // Full recipient address including +suffix. Example: `inbox+alias@domain.com`

OAIInboxControllerApi*apiInstance = [[OAIInboxControllerApi alloc] init];

// Get or create a plus address by full address
[apiInstance getOrCreateInboxPlusAddressWithInboxId:inboxId
          ...
          completionHandler: ^(OAIPlusAddressDto* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getOrCreateInboxPlusAddress: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**NSString***]()| ID of the inbox you want to target | 
 **fullAddress** | **NSString***| Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; | 
...
// Get or create a plus address by full address without inbox ID
[apiInstance getOrCreatePlusAddressByFullAddressWithFullAddress:fullAddress
          completionHandler: ^(OAIPlusAddressDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getOrCreatePlusAddressByFullAddress: %@", error);
                        }
                    }];
```
...
// List all inboxes with sent emails
[apiInstance getOutboxesWithPage:page
              size:size
              sort:sort
          completionHandler: ^(OAIPageInboxProjection* output, NSError* error) {
                        if (output) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIInboxControllerApi->getOutboxes: %@", error);
                        }
                    }];
```
