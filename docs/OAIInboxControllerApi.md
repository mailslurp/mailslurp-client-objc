...
------------- | ------------- | -------------
[**createInbox**](OAIInboxControllerApi#createinbox) | **POST** /inboxes | Create an inbox email address. An inbox has a real email address and can send and receive emails.
