...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domainOptions** | [**OAICreateDomainOptions***](OAICreateDomainOptions)| domainOptions | 
...
------------- | ------------- | ------------- | -------------
 **_id** | [**NSString***]()| id | 
 **updateDomainDto** | [**OAIUpdateDomainOptions***](OAIUpdateDomainOptions)| updateDomainDto | 
