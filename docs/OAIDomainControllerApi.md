...
[**getAvailableDomainRegions**](OAIDomainControllerApi#getavailabledomainregions) | **GET** /domains/available-domain-regions | Get all usable domains with account region status
[**getAvailableDomains**](OAIDomainControllerApi#getavailabledomains) | **GET** /domains/available-domains | Get all usable domains
[**getDomain**](OAIDomainControllerApi#getdomain) | **GET** /domains/{id} | Get a domain
[**getDomainIssues**](OAIDomainControllerApi#getdomainissues) | **GET** /domains/issues | Get domain issues
...
[**getMailSlurpDomains**](OAIDomainControllerApi#getmailslurpdomains) | **GET** /domains/mailslurp-domains | Get MailSlurp domains
...
// Get all usable domains with account region status
[apiInstance getAvailableDomainRegionsWithInboxType:inboxType
          completionHandler: ^(OAIDomainRegionGroupsDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIDomainControllerApi->getAvailableDomainRegions: %@", error);
                        }
                    }];
```
...
[**OAIDomainRegionGroupsDto***](OAIDomainRegionGroupsDto)
...
// Get all usable domains
[apiInstance getAvailableDomainsWithInboxType:inboxType
          completionHandler: ^(OAIDomainGroupsDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIDomainControllerApi->getAvailableDomains: %@", error);
                        }
                    }];
```
...
[**OAIDomainGroupsDto***](OAIDomainGroupsDto)
...
NSString* _id = @"_id_example"; // 
NSNumber* checkForErrors = @56; //  (optional)
...
------------- | ------------- | ------------- | -------------
 **_id** | [**NSString***]()|  | 
 **checkForErrors** | **NSNumber***|  | [optional] 
...
// Get domain issues
[apiInstance getDomainIssuesWithCompletionHandler: 
          ^(OAIDomainIssuesDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIDomainControllerApi->getDomainIssues: %@", error);
                        }
                    }];
```
...
[**OAIDomainIssuesDto***](OAIDomainIssuesDto)
...
// Get MailSlurp domains
[apiInstance getMailSlurpDomainsWithInboxType:inboxType
          completionHandler: ^(OAIDomainGroupsDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIDomainControllerApi->getMailSlurpDomains: %@", error);
                        }
                    }];
```
