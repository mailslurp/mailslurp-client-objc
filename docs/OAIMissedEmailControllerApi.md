...
// Get all MissedEmails in paginated format
[apiInstance getAllMissedEmailsWithBefore:before
              inboxId:inboxId
              page:page
...
// Get all unknown missed emails in paginated format
[apiInstance getAllUnknownMissedEmailsWithBefore:before
              inboxId:inboxId
              page:page
              searchFilter:searchFilter
              since:since
...
// Wait for Nth missed email
[apiInstance waitForNthMissedEmailWithBefore:before
              inboxId:inboxId
              index:index
              since:since
              timeout:timeout
