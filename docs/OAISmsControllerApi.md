...
[**getSmsCodes**](OAISmsControllerApi#getsmscodes) | **POST** /sms/{smsId}/codes | Extract verification codes from an SMS
...
[**markAllSmsAsRead**](OAISmsControllerApi#markallsmsasread) | **PATCH** /sms/read | Mark all SMS messages as read or unread
[**markSmsAsRead**](OAISmsControllerApi#marksmsasread) | **PATCH** /sms/{smsId}/read | Mark an SMS as read or unread
...
# **getSmsCodes**
```objc
-(NSURLSessionTask*) getSmsCodesWithSmsId: (NSString*) smsId
...
NSString* smsId = @"smsId_example"; // ID of SMS to extract codes from
OAIExtractCodesOptions* extractCodesOptions = [[OAIExtractCodesOptions alloc] init]; //  (optional)

OAISmsControllerApi*apiInstance = [[OAISmsControllerApi alloc] init];

// Extract verification codes from an SMS
[apiInstance getSmsCodesWithSmsId:smsId
          ...
          completionHandler: ^(OAIExtractCodesResult* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAISmsControllerApi->getSmsCodes: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **smsId** | [**NSString***]()| ID of SMS to extract codes from | 
...
# **markAllSmsAsRead**
```objc
-(NSURLSessionTask*) markAllSmsAsReadWithRead: (NSNumber*) read
...
NSNumber* read = @(YES); //  (optional) (default to @(YES))
NSString* phoneNumberId = @"phoneNumberId_example"; //  (optional)

OAISmsControllerApi*apiInstance = [[OAISmsControllerApi alloc] init];

// Mark all SMS messages as read or unread
[apiInstance markAllSmsAsReadWithRead:read
              phoneNumberId:phoneNumberId
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling OAISmsControllerApi->markAllSmsAsRead: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **read** | **NSNumber***|  | [optional] [default to @(YES)]
 **phoneNumberId** | [**NSString***]()|  | [optional] 
...
# **markSmsAsRead**
```objc
-(NSURLSessionTask*) markSmsAsReadWithSmsId: (NSString*) smsId
    read: (NSNumber*) read
        completionHandler: (void (^)(OAISmsDto* output, NSError* error)) handler;
```
...
// Mark an SMS as read or unread
[apiInstance markSmsAsReadWithSmsId:smsId
              read:read
          completionHandler: ^(OAISmsDto* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling OAISmsControllerApi->markSmsAsRead: %@", error);
                        }
                    }];
```
