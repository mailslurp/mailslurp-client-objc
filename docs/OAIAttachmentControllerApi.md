...
[**extractAttachmentText**](OAIAttachmentControllerApi#extractattachmenttext) | **POST** /attachments/{attachmentId}/text | Extract text from an attachment
...
```objc
-(NSURLSessionTask*) extractAttachmentTextWithAttachmentId: (NSString*) attachmentId
    extractAttachmentTextOptions: (OAIExtractAttachmentTextOptions*) extractAttachmentTextOptions
        completionHandler: (void (^)(OAIExtractAttachmentTextResult* output, NSError* error)) handler;
```
...
NSString* attachmentId = @"attachmentId_example"; // ID of attachment
OAIExtractAttachmentTextOptions* extractAttachmentTextOptions = [[OAIExtractAttachmentTextOptions alloc] init]; //  (optional)

OAIAttachmentControllerApi*apiInstance = [[OAIAttachmentControllerApi alloc] init];

// Extract text from an attachment
[apiInstance extractAttachmentTextWithAttachmentId:attachmentId
              extractAttachmentTextOptions:extractAttachmentTextOptions
          completionHandler: ^(OAIExtractAttachmentTextResult* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIAttachmentControllerApi->extractAttachmentText: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **attachmentId** | **NSString***| ID of attachment | 
 **extractAttachmentTextOptions** | [**OAIExtractAttachmentTextOptions***](OAIExtractAttachmentTextOptions)|  | [optional] 

### Return type

[**OAIExtractAttachmentTextResult***](OAIExtractAttachmentTextResult)
 ...
 **inlineObject1** | [**OAIInlineObject1***](OAIInlineObject1)|  | [optional] 
