...
------------- | ------------- | -------------
[**uploadAttachment**](OAIAttachmentControllerApi.md#uploadattachment) | **POST** /attachments | Upload an attachment for sending using base64 file encoding
[**uploadAttachmentBytes**](OAIAttachmentControllerApi.md#uploadattachmentbytes) | **POST** /attachments/bytes | Upload an attachment for sending using file byte stream input octet stream
...
```objc
-(NSURLSessionTask*) uploadAttachmentBytesWithFilename: (NSString*) filename
        completionHandler: (void (^)(NSArray<NSString*>* output, NSError* error)) handler;
```
...
// Upload an attachment for sending using file byte stream input octet stream
[apiInstance uploadAttachmentBytesWithFilename:filename
          completionHandler: ^(NSArray<NSString*>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
