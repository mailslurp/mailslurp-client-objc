...
```objc
-(NSURLSessionTask*) createNewInboxRulesetWithInboxId: (NSString*) inboxId
...
NSString* inboxId = @"inboxId_example"; // Inbox id to attach ruleset to
...
// Create an inbox ruleset
[apiInstance createNewInboxRulesetWithInboxId:inboxId
...
------------- | ------------- | ------------- | -------------
 **inboxId** | [**NSString***]()| Inbox id to attach ruleset to | 
